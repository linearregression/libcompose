...
func (client *NopClient) ContainerWait(ctx context.Context, containerID string) (int64, error) {
...
func (client *NopClient) Ping(ctx context.Context) (bool, error) {
	return true, errNoEngine
}
